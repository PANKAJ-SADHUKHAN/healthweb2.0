...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
      <div class="column">
        <div class="card">
          ...
          <div class="container">
            ...
            <a
              class="social-icon"
              href="https://www.facebook.com/ronalghosh2.00"
              target="_blank"
            >
      ...
      <div class="column">
        <div class="card">
          ...
          <div class="container">
            ...
            <a
              class="social-icon"
              href="https://www.facebook.com/olivia.karmakar.184"
              target="_blank"
            >
      ...
      <div class="column">
        <div class="card">
          <img src="image/pkj.jpg" alt="image" style="width: 100%" />
          <div class="container">
            ...
            <a
              class="social-icon"
              href="https://www.facebook.com/pankaj.sadhukhan.94"
              target="_blank"
            >
              <ion-icon name="logo-facebook"size="large"></ion-icon>
            </a>
